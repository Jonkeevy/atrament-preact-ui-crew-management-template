  ...
  return (
    <Container>
      <ContainerFlex>
        <Settings />
        <Header>
          <img src="assets/icons/speaker_audio_sound.png" style={{margin: 'auto', display: 'block'}} />
          <h1>{title ? title : "Atrament UI"}</h1>
          <p>{author ? `${author}` : "Test application"}</p>
        </Header>
        <Block align='end'>
          ...
          <LinkMenu key="about Atrament UI" onClick={aboutGame}>About Atrament UI</LinkMenu>
        </Block>
      </ContainerFlex>
    </Container>
  );
